...
namespace ShipperClient.NwService {
    ...
    public interface IShipperService {
        ...
        ShipperClient.NwService.Shipper GetShipperId(int shipperId);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IShipperService/GetShipperId", ReplyAction="http://tempuri.org/IShipperService/GetShipperIdResponse")]
        System.Threading.Tasks.Task<ShipperClient.NwService.Shipper> GetShipperIdAsync(int shipperId);
        ...
        void SaveShipper(ShipperClient.NwService.Shipper shipper);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IShipperService/SaveShipper", ReplyAction="http://tempuri.org/IShipperService/SaveShipperResponse")]
        System.Threading.Tasks.Task SaveShipperAsync(ShipperClient.NwService.Shipper shipper);
    }
    ...
    public partial class ShipperServiceClient : System.ServiceModel.ClientBase<ShipperClient.NwService.IShipperService>, ShipperClient.NwService.IShipperService {
        ...
        public ShipperClient.NwService.Shipper GetShipperId(int shipperId) {
            return base.Channel.GetShipperId(shipperId);
        }
        
        public System.Threading.Tasks.Task<ShipperClient.NwService.Shipper> GetShipperIdAsync(int shipperId) {
            return base.Channel.GetShipperIdAsync(shipperId);
        }
        
        public void SaveShipper(ShipperClient.NwService.Shipper shipper) {
            base.Channel.SaveShipper(shipper);
        }
        
        public System.Threading.Tasks.Task SaveShipperAsync(ShipperClient.NwService.Shipper shipper) {
